...
public class PhotoPicker {
    ...
    public final static String EXTRA_DIR_PHOTOS = "DIR_PHOTOS";
    ...
    public static class PhotoPickerBuilder {
        ...
        public PhotoPickerBuilder setDir(ArrayList<String> imagesUri) {
            mPickerOptionsBundle.putStringArrayList(EXTRA_DIR_PHOTOS, imagesUri);
            return this;
        }
