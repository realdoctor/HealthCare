...
public class ColorfulProgressbar extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        widthSize = widthMode == MeasureSpec.EXACTLY ? widthSize : SizeUtils.dip2px(getContext(), 200);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!once) {
            ...
            backgroundMaskView.setBackgroundResource(R.drawable.progress_bg);
            ...
            percentView.setTextSize(SizeUtils.px2sp(getContext(), (float) (getMeasuredHeight() * 0.8)));
            ...
            if (animationOn) {
                ...
                translateAnimation.setDuration((long) (8000 * (float) getMeasuredWidth() / ScreenUtil.getScreenWidth(getContext())));
