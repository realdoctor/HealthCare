...
/**
 * Created by zhujiabin on 2010/5/14.
 */
...
public class CircleBtnView extends View{
    ...
    public CircleBtnView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleBtnView);
        mMinTime=a.getInt(R.styleable.CircleBtnView_minTime,0);
        mTime=a.getInt(R.styleable.CircleBtnView_maxTime,10);
        mProgressW=a.getDimension(R.styleable.CircleBtnView_progressWidth,12f);
        mProgressColor=a.getColor(R.styleable.CircleBtnView_progressColor,Color.parseColor("#6ABF66"));
        a.recycle();
        //初始画笔抗锯齿、颜色
