 ...
 */
package com.real.doctor.realdoc.view.scanner.camera;
...
public final class CameraConfigurationManager {
    ...
    public void initFromCameraParameters(Camera camera) {
        ...
        WindowManager manager = (WindowManager) RealDocApplication.getContext().getSystemService(Context.WINDOW_SERVICE);
