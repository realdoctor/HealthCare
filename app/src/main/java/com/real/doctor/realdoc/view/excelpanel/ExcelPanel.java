 ...
 * Your adapter extends BaseExcelPanelAdapter can provide data to excelPanel.
...
public class ExcelPanel extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public ExcelPanel(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
            leftCellWidth = (int) a.getDimension(R.styleable.ExcelPanel_left_cell_width, SizeUtils.dp2px(getContext(), DEFAULT_LENGTH));
            topCellHeight = (int) a.getDimension(R.styleable.ExcelPanel_top_cell_height, SizeUtils.dp2px(getContext(), DEFAULT_LENGTH));
            normalCellWidth = (int) a.getDimension(R.styleable.ExcelPanel_normal_cell_width, SizeUtils.dp2px(getContext(), DEFAULT_LENGTH));
        } finally {
            a.recycle();
        }
        indexHeight = new TreeMap<>();
        loadingViewWidth = SizeUtils.dp2px(getContext(), LOADING_VIEW_WIDTH);
        initWidget();
    }
