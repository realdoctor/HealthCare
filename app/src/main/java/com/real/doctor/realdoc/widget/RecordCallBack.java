...
/**
 * 自定义拖拽
 * Created by zhujiabin on 2017/6/19 下午5:42.
 * 邮箱:414037481@qq.com
 */

public class RecordCallBack extends ItemTouchHelper.Callback {
    ...
    public RecordCallBack(RecordImgAdapter adapter, List<String> images, List<String> originImages) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (dY >= (recyclerView.getHeight()
                ...
                - DocUtils.getPixelById(R.dimen.record_images_delete))) {//拖到删除处
