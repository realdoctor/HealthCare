...
public class HuanXinPreferenceManager {
    /**
     * name of preference
     */
    public static final String PREFERENCE_NAME = "saveInfo";
    private static SharedPreferences mSharedPreferences;
    private static HuanXinPreferenceManager mPreferencemManager;
    ...
    private HuanXinPreferenceManager(Context cxt) {
    ...
    public static synchronized void init(Context cxt) {
        if (mPreferencemManager == null) {
            mPreferencemManager = new HuanXinPreferenceManager(cxt);
        }
    }

    /**
     * get instance of HuanXinPreferenceManager
     *
     * @param
     * @return
     */
    public synchronized static HuanXinPreferenceManager getInstance() {
        if (mPreferencemManager == null) {
