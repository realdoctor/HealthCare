...
import com.real.doctor.realdoc.rxjavaretrofit.down.DownLoadListener.DownloadInterceptor;
import com.real.doctor.realdoc.rxjavaretrofit.exception.HttpTimeException;
import com.real.doctor.realdoc.rxjavaretrofit.exception.RetryWhenNetworkException;
import com.real.doctor.realdoc.rxjavaretrofit.http.HttpNetUtil;
import com.real.doctor.realdoc.rxjavaretrofit.subscribers.ProgressDownSubscriber;
...
public class HttpDownManager {
    ...
    public void startDown(final DownInfo info) {
        ...
        httpService.download("bytes=" + info.getReadLength() + "-", info.getUrl())
                ...
                /*数据回调*/
                .subscribe((Observer<? super DownInfo>) subscriber);
