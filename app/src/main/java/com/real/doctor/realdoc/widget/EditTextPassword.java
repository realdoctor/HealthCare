...
import com.real.doctor.realdoc.util.FontCache;
...
public class EditTextPassword extends AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            this.showPasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_showPasswordIcon, R.mipmap.ic_show_password);
            this.hidePasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_hidePasswordIcon, R.mipmap.ic_hide_password);
