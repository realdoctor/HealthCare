...
public class SelectPopupWindowUpload extends PopupWindow {
    ...
    public SelectPopupWindowUpload(Activity context, OnClickListener itemsOnClick) {
        super(context);
        mContext = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.select_popup_layout_upload, null);
